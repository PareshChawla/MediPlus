...
const ContactCard = ({ logo, title, content }) => {
  return (
    <div className='flex justify-center'>
      <div className='border-2  w-[80%] lg:w-[400px] min-h-full lg:h-70  flex flex-col items-center bg-[#EFECEC] p-6 hover:bg-[#6CB250] hover:text-white transition-colors duration-200 ease-in-out'>
