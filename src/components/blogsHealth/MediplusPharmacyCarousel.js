...
const MediplusPharmacyCarousel = ({
  img,
  mediplustitle,
  mediplusName,
  mediplusDetails,
  ...
  return (
    <div className="bg-white shadow-md mb-5 mt-8 px-2 pt-1 lg:m-2 overflow-hidden flex flex-col">
      ...
      <h2 className="mt-2 mx-6 mb-4 text-xl text-[#3470a1] hover:text-[#6cb250] cursor-pointer font-bold">
        {mediplusName}
      </h2>
...
export default MediplusPharmacyCarousel;
