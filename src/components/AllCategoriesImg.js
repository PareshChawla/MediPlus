...
const AllCategoriesImg = ({ CategoryImg, CategoryText, CategoryBtn }) => {
  ...
  return (
    <div>
      <div
        className="bg-white md:w-72 h-52 flex justify-center items-center border rounded-sm overflow-hidden"
      ...
      <div className="flex justify-center items-center pb-10 md:pb-20">
