    ...
    <>
      ...
      <div className="w-full justify-center md:flex md:flex-row flex-col ">
        <AllCategoriesImg
          ...
          CategoryText={"Baby Care"}
          CategoryBtn={<Link to="/category/baby-care">Baby Care</Link>}
        />
        <AllCategoriesImg
          CategoryImg={HB}
      ...
      <div className="relative w-full">
        <img
          className="w-full h-[500px] brightness-75 object-cover"
          src={banner}
          alt="Img1"
        />
        <div className="absolute inset-0 flex flex-col justify-center items-end text-white">
          <div className="text-right px-8">
            <h1 className="text-4xl font-bold mb-4">
              Get Medicines and Health Products
              <br />
              of Reputed Brands
            </h1>
            <p className="text-lg">
              Browse our wide range of Ayurveda & Herbal supplements. Buy
              healthcare products and
              <br /> health devices at one place.
            </p>
            <Link to="/products">
