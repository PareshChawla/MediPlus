...
const CardFullfillment = ({logo, title, content}) => {
  return (
    <div className='border-2 border-[#6CB250] hover:border-[#3470a1] w-[100%] lg:w-[370px] h-80 rounded-xl flex flex-col shadow-lg hover:shadow-xl hover:shadow-blue-500/10  items-center'>
